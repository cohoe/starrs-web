...
class Search extends ImpulseController {
	...
	public function index() {
		if($this->input->post()) {
			...
			$results[] = array("Datacenter","Availability Zone","System Name","Asset","Group","Platform","MAC","Address","Config","System Owner","System Last Modifier","Range","Hostname","Zone","DNS Owner","DNS Last Modifier");
