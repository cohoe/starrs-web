<div class="span7 well">
	...
	<table class="table table-striped table-bordered imp-dnstable">
		...
		foreach($intAddrs as $intAddr) {
			...
			"</td><td><div class=\"btn-group\"><a class=\"btn btn-mini btn-info renew\" href=\"/address/renew/".rawurlencode($intAddr->get_address())."\">Renew</a><a class=\"btn btn-mini btn-danger renewremove\" href=\"/address/remove/".rawurlencode($intAddr->get_address())."\">Remove</a></div></td></tr>";
		}
		?>
	</table>
</div>
